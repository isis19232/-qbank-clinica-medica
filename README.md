...
Veja [`docs/02-architecture.md`](docs/02-architecture.md#deploy-em-produção-vercel--postgresql)
para detalhes e como evoluir o schema depois do primeiro deploy.
...
| `AUTH_SECRET` | Não | Reservado para uso futuro — a sessão atual usa token opaco com hash SHA-256, sem JWT |
